`ifndef AXI4_NON_OUTSTANDING_8B_WRITE_DATA_TEST_INCLUDED_
`define AXI4_NON_OUTSTANDING_8B_WRITE_DATA_TEST_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: axi4_non_outstanding_8b_write_data_test
// Extends the base test and starts the virtual sequenceof write
//--------------------------------------------------------------------------------------------
class axi4_non_outstanding_8b_write_data_test extends axi4_base_test;
  `uvm_component_utils(axi4_non_outstanding_8b_write_data_test)
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi4_non_outstanding_8b_write_data_test", uvm_component parent = null);
...
//
// Parameters:
//  name - axi4_non_outstanding_8b_write_data_test
//  parent - parent under which this component is created
//--------------------------------------------------------------------------------------------
function axi4_non_outstanding_8b_write_data_test::new(string name = "axi4_non_outstanding_8b_write_data_test",
