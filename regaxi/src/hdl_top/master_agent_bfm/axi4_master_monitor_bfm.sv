...
interface axi4_master_monitor_bfm(input bit aclk, input bit aresetn,
  ...
  clocking masterMonCb@(posedge aclk);
   ...
   input awid ,awaddr, awlen,awsize,awburst,awlock,awcache,awprot,awvalid,awready,wdata,wstrb,wlast,wuser,wvalid,wready,bid,bresp,buser,bvalid,bready,arid,araddr,arlen,arsize,arburst,arlock,arcache,arprot,arqos,arregion,aruser,arvalid,arready,rid,rdata,rresp,rlast,ruser,rvalid,rready;
  endclocking 
