...
class axi4_non_outstanding_only_read_response_out_of_order_test extends axi4_base_test;
  `uvm_component_utils(axi4_non_outstanding_only_read_response_out_of_order_test)
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi4_non_outstanding_only_read_response_out_of_order_test", uvm_component parent = null);
  
  extern function void setup_axi4_env_cfg();
  extern virtual function void setup_axi4_slave_agent_cfg();
  extern virtual task run_phase(uvm_phase phase);

endclass : axi4_non_outstanding_only_read_response_out_of_order_test
...
//--------------------------------------------------------------------------------------------
function axi4_non_outstanding_only_read_response_out_of_order_test::new(string name = "axi4_non_outstanding_only_read_response_out_of_order_test",
                                 uvm_component parent = null);
  super.new(name, parent);
endfunction : new


function void axi4_non_outstanding_only_read_response_out_of_order_test::setup_axi4_env_cfg();
...
//--------------------------------------------------------------------------------------------
function void axi4_non_outstanding_only_read_response_out_of_order_test::setup_axi4_slave_agent_cfg();
...
//  phase - uvm phase
//--------------------------------------------------------------------------------------------
task axi4_non_outstanding_only_read_response_out_of_order_test::run_phase(uvm_phase phase);
  ...
  `uvm_info(get_type_name(),$sformatf("axi4_non_outstanding_only_read_response_out_of_order_test"),UVM_LOW);
