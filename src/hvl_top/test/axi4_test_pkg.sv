...
package axi4_test_pkg;
  ...
  `include "axi4_outstanding_exokay_response_write_test.sv"
  `include "axi4_outstanding_okay_response_write_test.sv"
  ...
  `include "axi4_non_outstanding_exokay_write_response_test.sv"
  `include "axi4_non_outstanding_okay_write_response_test.sv"
  ...
  `include "axi4_outstanding_outstanding_transfer_write_read_test.sv"
  ...
  `include "axi4_non_outstanding_outstanding_transfer_write_read_test.sv"
  ...
  `include "axi4_non_outstanding_slave_mem_mode_wrap_burst_write_read_test.sv"
  `include "axi4_non_outstanding_slave_mem_mode_fixed_burst_write_read_test.sv"
  `include "axi4_non_outstanding_slave_mem_mode_incr_burst_write_read_test.sv"
  

  `include "axi4_non_outstanding_write_read_response_out_of_order_test.sv"
  `include "axi4_non_outstanding_only_read_response_out_of_order_test.sv"
  `include "axi4_non_outstanding_only_write_response_out_of_order_test.sv"

  `include "axi4_non_outstanding_qos_write_read_test.sv"
