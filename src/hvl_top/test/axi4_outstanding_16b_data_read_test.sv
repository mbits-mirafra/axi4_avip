`ifndef AXI4_OUTSTANDING_16B_DATA_READ_TEST_INCLUDED_
`define AXI4_OUTSTANDING_16B_DATA_READ_TEST_INCLUDED_
...
class axi4_outstanding_16b_data_read_test extends axi4_base_test;
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi4_outstanding_16b_data_read_test", uvm_component parent = null);
  extern function void setup_axi4_env_cfg();
  extern virtual task run_phase(uvm_phase phase);
  extern virtual function void build_phase(uvm_phase phase);
endclass : axi4_outstanding_16b_data_read_test
...
//--------------------------------------------------------------------------------------------
function axi4_outstanding_16b_data_read_test::new(string name = "axi4_outstanding_16b_data_read_test",
                                 uvm_component parent = null);
  super.new(name, parent);
endfunction : new

function void axi4_outstanding_16b_data_read_test :: build_phase(uvm_phase phase);
 super.build_phase(phase);
 axi4_env_cfg_h.axi4_slave_agent_cfg_h[0].slave_response_mode = ONLY_READ_RESP_OUT_OF_ORDER;
endfunction

function void axi4_outstanding_16b_data_read_test::setup_axi4_env_cfg();
...
//  phase - uvm phase
//--------------------------------------------------------------------------------------------
task axi4_outstanding_16b_data_read_test::run_phase(uvm_phase phase);
