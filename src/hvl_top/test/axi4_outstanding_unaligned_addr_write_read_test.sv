`ifndef AXI4_OUTSTANDING_UNALIGNED_ADDR_WRITE_READ_TEST_INCLUDED_
`define AXI4_OUTSTANDING_UNALIGNED_ADDR_WRITE_READ_TEST_INCLUDED_
...
class axi4_outstanding_unaligned_addr_write_read_test extends axi4_base_test;
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi4_outstanding_unaligned_addr_write_read_test", uvm_component parent = null);
  extern virtual task run_phase(uvm_phase phase);

endclass : axi4_outstanding_unaligned_addr_write_read_test

//--------------------------------------------------------------------------------------------
// Construct: new
//
// Parameters:
//  name - axi4_outstanding_unaligned_addr_write_read_test
//  parent - parent under which this component is created
//--------------------------------------------------------------------------------------------
function axi4_outstanding_unaligned_addr_write_read_test::new(string name = "axi4_outstanding_unaligned_addr_write_read_test",
