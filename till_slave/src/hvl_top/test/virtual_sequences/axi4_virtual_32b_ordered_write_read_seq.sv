...
//--------------------------------------------------------------------------------------------
// Class: axi4_virtual_32b_ordered_write_read_seq
// Creates and starts the master and slave sequences
//--------------------------------------------------------------------------------------------
class axi4_virtual_32b_ordered_write_read_seq extends axi4_virtual_base_seq;
  `uvm_object_utils(axi4_virtual_32b_ordered_write_read_seq)
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi4_virtual_32b_ordered_write_read_seq");
  extern task body();
endclass : axi4_virtual_32b_ordered_write_read_seq
...
//
// Parameters:
//  name - axi4_virtual_32b_ordered_write_read_seq
//--------------------------------------------------------------------------------------------
function axi4_virtual_32b_ordered_write_read_seq::new(string name = "axi4_virtual_32b_ordered_write_read_seq");
  super.new(name);
endfunction : new
...
//--------------------------------------------------------------------------------------------
task axi4_virtual_32b_ordered_write_read_seq::body();
  ...
  `uvm_info(get_type_name(), $sformatf("DEBUG_MSHA :: Insdie axi4_virtual_32b_ordered_write_read_seq"), UVM_NONE); 
