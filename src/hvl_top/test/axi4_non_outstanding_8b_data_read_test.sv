...
//--------------------------------------------------------------------------------------------
function axi4_non_outstanding_8b_data_read_test::new(string name = "axi4_non_outstanding_8b_data_read_test",
                                 uvm_component parent = null);
  super.new(name, parent);
endfunction : new
function void axi4_non_outstanding_8b_data_read_test :: build_phase(uvm_phase phase);
