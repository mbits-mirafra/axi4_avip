...
//--------------------------------------------------------------------------------------------
class axi4_non_outstanding_8b_data_read_test extends axi4_base_test;
  `uvm_component_utils(axi4_non_outstanding_8b_data_read_test)

  //Variable : axi4_virtual_bk_8b_data_read_seq_h
  //Instatiation of axi4_virtual_write_seq
  axi4_virtual_read_seq axi4_virtual_bk_8b_data_read_seq_h;
  
  //-------------------------------------------------------
  // Externally defined Tasks and Functions
  //-------------------------------------------------------
  extern function new(string name = "axi4_non_outstanding_8b_data_read_test", uvm_component parent = null);
  extern function void setup_axi4_env_cfg();
extern virtual task run_phase(uvm_phase phase);

endclass : axi4_non_outstanding_8b_data_read_test
...
//--------------------------------------------------------------------------------------------
function axi4_non_outstanding_8b_data_read_test::new(string name = "axi4_non_outstanding_8b_data_read_test",uvm_component parent = null);
  super.new(name, parent);
endfunction : new



function void axi4_non_outstanding_8b_data_read_test::setup_axi4_env_cfg();
...
//  phase - uvm phase
//--------------------------------------------------------------------------------------------
task axi4_non_outstanding_8b_data_read_test::run_phase(uvm_phase phase);
