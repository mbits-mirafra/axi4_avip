`ifndef AXI4_OUTSTANDING_OKAY_RESPONSE_READ_TEST_INCLUDED_
`define AXI4_OUTSTANDING_OKAY_RESPONSE_READ_TEST_INCLUDED_
...
class axi4_outstanding_okay_response_read_test extends axi4_base_test;
  ...
  //-------------------------------------------------------
  extern function new(string name = "axi4_outstanding_okay_response_read_test", uvm_component parent = null);
  extern function void setup_axi4_env_cfg();
  extern virtual task run_phase(uvm_phase phase);

endclass : axi4_outstanding_okay_response_read_test
...
//--------------------------------------------------------------------------------------------
function axi4_outstanding_okay_response_read_test::new(string name = "axi4_outstanding_okay_response_read_test",
